...
1. Clone repository
   ...
   ```sh
   git clone https://github.com/flex-development/fst
   cd fst
   ```
...
```sh
https://github.com/flex-development/fst/compare/main...$branch
```
...
[qa]: https://github.com/flex-development/fst/discussions/new?category=q-a
